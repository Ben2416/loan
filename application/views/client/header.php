...
<head>
    ...
    <title><?php echo $page_title; ?> | Bayelsa Loan Management System</title>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/global/vendor/waves/waves.min3f0d.css?v2.2.0">

    <!-- Page -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/examples/css/pages/login.min3f0d.css?v2.2.0">
    <!-- Plugins For This Page -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/global/vendor/bootstrap-sweetalert/sweet-alert.min3f0d.css?v2.2.0">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/global/vendor/toastr/toastr.min3f0d.css?v2.2.0">

    <!-- Plugins For jQuery wizard form validation -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/global/vendor/jquery-wizard/jquery-wizard.min.css?v2.2.0">
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/global/vendor/formvalidation/formValidation.min.css?v2.2.0">

    <!-- Fonts -->
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/global/fonts/material-design/material-design.min3f0d.css?v2.2.0">
