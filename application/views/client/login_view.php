...
<div class="page animsition vertical-align text-center" data-animsition-in="fade-in"
    ...
    <div class="page-content vertical-align-middle">
        ...
        <?php echo form_open(base_url().'client/login',$attributes); ?><!--<form method="post" action="" autocomplete="off">-->
        ...
        <div class="form-group clearfix">
            ...
            <a class="pull-right" href="login/forgot_password">Forgot password?</a>
        </div>
